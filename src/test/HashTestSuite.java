...
public class HashTestSuite {
     ...
     */
    private static HashTestSuite instance = null;
     ...
     */
    public static HashTestSuite getInstance() {
        if (instance == null) instance = new HashTestSuite();
        return instance;
    }
    ...
    private static List<TestCase> generateTestCases() {
        ...
        testCases.add(new TestCase("InsertAndGet", HashTestMethods::constructTest));
        testCases.add(new TestCase("InsertNull", HashTestMethods::addOne));
